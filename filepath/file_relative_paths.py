...
class ImagePathAndProps(Enum):
    ...
    CHECKED_BUTTON_IMAGE_PATH = ['resource\\checked.png',
                                       (1280, 720), (0, 0, 0, 0), 0.7, 25, CHECKED]
    ...
    TITLE_IMG_PATH = ['resource\\title.png',
                       (1280, 720), (0, 0, 0, 0), 0.90, 25, TITLE]
...
class GuiCheckImagePathAndProps(Enum):
    ...
    TITLE_IMG_PATH = ['resource\\title.png',
                       (1280, 720), (0, 0, 0, 0), 0.90, 25, TITLE]
    CHECKED_BUTTON_IMAGE_PATH = ['resource\\checked.png',
                                       (1280, 720), (0, 0, 0, 0), 0.90, 25, CHECKED]
...
GuiCheckImagePathAndPropsOrdered = [
    ...
    GuiCheckImagePathAndProps.TITLE_IMG_PATH,
    GuiCheckImagePathAndProps.CHECKED_BUTTON_IMAGE_PATH
